# Generated by Django 3.2.15 on 2022-09-07 08:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additional', models.ManyToManyField(blank=True, related_name='additional_from', to='first.Food', verbose_name='Дополнительные товары')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='food', to='first.foodcategory', verbose_name='Раздел меню')),
            ],
            options={
                'abstract': False,
            },
